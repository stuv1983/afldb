...
- **Status:** Open — Stage 2 (implementation, tests, docs) complete on `claude/issue-130`; **awaiting Stage 3 host validation on the dev host** (runbook §9.6)
- **Severity:** Medium
