...
- `tools/records/import-first-kick-goal.ts` is unchanged and still reloads destructively; `AFLDB-ISSUE-078` stays open for it.
...
- The same defect remains in the draft and first-kick-goal reloads, recorded as `AFLDB-ISSUE-078`; neither importer was changed here.
