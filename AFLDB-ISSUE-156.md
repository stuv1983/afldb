...
| P4 | **AFLDB-ISSUE-167** | Special records — first-kick / after-siren (family deferred pending decision D-1) | Phase E (§23, §12) | medium-high | suppress operation proven reload-safe — see §P4 handoff contract below. **Allocated and planned 2026-09-13; unimplemented, undeployed, uncommitted** |
...
`opus/issue-167-special-records-admin`. Planning is complete; nothing is implemented, committed or
deployed. See the §P4 handoff contract at the end of this document. P6, P7, P9–P12 remain
...
worktree; no 167 branch or commit anywhere in history; `git diff --check` clean). Planning only — no
application code, migration, privilege, test or deployment change was made; nothing staged or
committed. **All four operator decisions are recorded.** The authoritative contract is
