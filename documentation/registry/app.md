<!-- DOC | Curated API annotations for the Next.js App Router route and page module -->
...
`node .phaneslight/scripts/cli.js list-apis app`, or `semble search` where it is installed.
