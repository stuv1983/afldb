<!-- DOC | Curated API annotations for the PostgreSQL query and migration module -->
...
`node .phaneslight/scripts/cli.js list-apis db`, or `semble search` where it is installed.
