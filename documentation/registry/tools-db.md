<!-- DOC | Curated API annotations for the database migration and privilege runner module -->
...
`node .phaneslight/scripts/cli.js list-apis tools-db`, or `semble search` where it is installed.
