<!-- DOC | Curated API annotations for the canonical database rebuild pipeline module -->
...
`node .phaneslight/scripts/cli.js list-apis tools-rebuild`, or `semble search` where it is installed.
