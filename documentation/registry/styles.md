<!-- DOC | Curated API annotations for the global stylesheet and theming module -->
...
`node .phaneslight/scripts/cli.js list-apis styles`, or `semble search` where it is installed.
