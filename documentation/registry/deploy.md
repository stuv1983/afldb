<!-- DOC | Curated API annotations for the systemd Caddy and cluster deployment module -->
...
`node .phaneslight/scripts/cli.js list-apis deploy`, or `semble search` where it is installed.
