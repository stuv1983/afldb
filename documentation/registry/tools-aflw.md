<!-- DOC | Curated API annotations for the AFLW parse and staging load module -->
...
`node .phaneslight/scripts/cli.js list-apis tools-aflw`, or `semble search` where it is installed.
