<!-- DOC | Curated API annotations for the natural language corpora and stress module -->
...
`node .phaneslight/scripts/cli.js list-apis tools-nl`, or `semble search` where it is installed.
