<!-- DOC | Curated API annotations for the operational admin build and validation module -->
...
`node .phaneslight/scripts/cli.js list-apis tools-ops`, or `semble search` where it is installed.
