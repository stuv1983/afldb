<!-- DOC | Curated API annotations for the host setup backup and restore module -->
...
`node .phaneslight/scripts/cli.js list-apis tools-maintenance`, or `semble search` where it is installed.
