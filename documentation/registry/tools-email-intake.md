<!-- DOC | Curated API annotations for the IMAP fetch and staging intake module -->
...
`node .phaneslight/scripts/cli.js list-apis tools-email-intake`, or `semble search` where it is installed.
