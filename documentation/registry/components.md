<!-- DOC | Curated API annotations for the shared React UI component module -->
...
`node .phaneslight/scripts/cli.js list-apis components`, or `semble search` where it is installed.
