<!-- DOC | Curated API annotations for auth settings email SEO and shared helpers -->
...
`node .phaneslight/scripts/cli.js list-apis lib`, or `semble search` where it is installed.
