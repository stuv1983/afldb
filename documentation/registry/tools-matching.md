<!-- DOC | Curated API annotations for the player link matching and backtest module -->
...
`node .phaneslight/scripts/cli.js list-apis tools-matching`, or `semble search` where it is installed.
