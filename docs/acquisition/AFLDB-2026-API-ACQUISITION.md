...
- **Scheduled chain may commit nothing until ISSUE-224 + S9** (ISSUE-244 F017, CLOSED / DEFERRED
  ...
  installation/enablement is separately authorised work. *(Annotated 2026-09-23, ISSUE-224
  closure: this guarded path completed — see the §14.0 status table's S9 annotation and
  `issues/closed/AFLDB-ISSUE-224.md`. The scheduled chain is no longer blocked on debutant
  registration; timer installation/enablement remains separately authorised work.)*
