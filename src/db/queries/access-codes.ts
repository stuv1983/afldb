 ...
 * one `authSql.begin` is enough, with `auditInTransaction` writing the
 * trail on this same handle. The DELETE grant itself is migration 091,
 * mirrored in tools/maintenance/privileges.sql.
 */
