 ...
 * counted once toward that family's combined total.
 */
...
/**
 * Father-son pairs, ranked by combined career games. Father/son is read
 * from person_a_role/person_b_role rather than assumed from column
