    ...
    <>
      ...
      <section className="section">
        ...
        <p className="section-note">
          ...
          A rename or relocation carries the club’s record forward; a merger does
          not, so the two sit in different columns.
        </p>
        <div className="table-wrap">
          <table>
            <caption>
              “Record continues as” is the same club under a later name. “Merged
              into” is a link only: neither club’s statistics are counted towards
              the combined club.
            </caption>
            <thead>
              <tr>
