...
`AFLDB-ISSUE-125`, `AFLDB-ISSUE-126`.
...
<!-- ALLOCATION WARNING 2026-09-01: `AFLDB-ISSUE-118` is allocated and is NOT free.
     ...
     **Next free issue ID is `AFLDB-ISSUE-127`.** None of 123-126 claims a migration number;
     `084` is the next number visible from this worktree but is NOT reserved, and any branch
     needing one must still re-scan every live branch tip before claiming it. -->
