...
- **Next action:** D-1…D-8 are DECIDED (2026-09-11; D-2 with modification — 2027 first authoritative season, 2026 appearances never promoted into membership; D-3 subject to the Stage 1 evidence gate; ISSUE-161 never depends on a fixture, likely ISSUE-162 owns fixtures). A fresh Opus 5 high session executes Stage 1 from `AFLDB-ISSUE-161.md` §29 (preflight `--issue 161`, allocate 096, migration, `admin-season-lists.ts`, replay branch, tests on `afldb_test`). Stage 2 (admin surface) follows; DEV/Playwright acceptance deferred to the Admin Centre batch.
