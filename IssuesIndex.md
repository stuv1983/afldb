...
`src/db/queries/nl/`). AFLDB-ISSUE-190 resolved 2026-09-15 (Sonnet 5); see `issues.md`.
...
Suggested order: 188, 187 (bounded Sonnet fixes, both P1), then 189 (needs adjudication),
191, 192.
